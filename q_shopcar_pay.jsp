...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：购物车 &gt; 购买</td>
      </tr>
      <tr>
...
<%--<%  int ID=readerForm.getId().intValue();
  ...
  %>--%>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td width="173" align="center">价&nbsp;&nbsp;&nbsp;&nbsp;格：</td>
      
          
          <td >
          <input name="id" type="text" id="id" value="<%--=ID--%>"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="center">&nbsp;</td>
        <td><input name="Submit" type="submit" class="btn_grey" value="支付" onClick="quit()">
&nbsp;
<script language="javascript">
			function quit(){
				if(confirm("支付成功！")){
					window.location.href="q_shopcar.jsp";
				}
			}
		</script>
